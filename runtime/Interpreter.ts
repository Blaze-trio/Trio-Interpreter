...
import { NodeType, Stemt, NumericLiteral, BinaryExpr, Program, Identifier, VariableDeclaration } from "../frontend/ast.ts";
import Environment from "./environment.ts";
import { eval_identifier, evaluateBinaryExpr } from "./eval/expressions.ts";

...
import { NodeType, Stemt, NumericLiteral, BinaryExpr, Program, Identifier, VariableDeclaration, AssignmentExpr, ObjectLiteral } from "../frontend/ast.ts";
import Environment from "./environment.ts";
import { eval_assignment_expr, eval_identifier, evaluateBinaryExpr, eval_object_expr } from "./eval/expressions.ts";
